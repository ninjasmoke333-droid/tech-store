...
export default function AsusZenfone12Ultra() {
  ...
  const products: Product[] = [
    {
      ...
      storage: '256GB',
      details: [
        '2400 × 1080 resolution, 165Hz adaptive refresh',
        'Up to 2500 nits peak brightness, HDR10+',
        '50MP main (Sony IMX890 OIS) + 13MP ultra-wide + 32MP 3x telephoto',
        'ZenUI 16 based on Android 16 with long-term updates',
    ...
    },
    {
      ...
      details: [
        ...
        '5500mAh battery optimized for all-day use',
        'Compact premium flagship design'
      ],
      price: '$999.00',
      monthlyPrice: '$83.25',
      finishes: ['Midnight Black', 'Glacier Silver', 'Aurora Blue'],
  ...
  const considerations = [
    {
      ...
      description: 'Flagship 3nm chipset delivering top-tier performance, efficiency, and AI capabilities in a compact form.',
      features: [
        'Oryon CPU cores with high clock speeds',
        'Adreno GPU for smooth gaming & multitasking',
    ...
    },
    {
      ...
      description: 'Smooth, bright, and color-accurate screen optimized for media and daily use.',
      features: [
        '2400 × 1080 resolution with 165Hz LTPO',
    ...
    },
    {
      ...
      description: 'Versatile camera setup with strong main sensor and telephoto zoom for photography enthusiasts.',
      features: [
        '50MP main (Sony IMX890) with OIS',
        '13MP ultra-wide + 32MP 3x telephoto',
    ...
    },
    {
      ...
      description: 'Long-lasting power with quick charging in a compact flagship design.',
      features: [
        '5500mAh battery for all-day usage',
        '65W wired charging (full charge ~35 min)',
    ...
    return (
      <div style={{
        ...
        {product.image && (
          <img
            src={product.image}
            alt={`${product.chip} ASUS Zenfone 12 Ultra`}
            style={{
              width: '100%',
      ...
      <main style={{ paddingTop: '60px', flex: '1' }}>
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            ASUS Zenfone 12 Ultra with Snapdragon 8 Elite and premium compact design.
          </h1>
          <p style={{
            ...
            Have questions about buying an ASUS Zenfone?
          </p>
          <button style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            What to consider when choosing your ASUS Zenfone 12 Ultra.
          </h2>
          <p style={{
            fontSize: '17px',
            color: '#6e6e73',
