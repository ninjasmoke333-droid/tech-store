...
export default function VivoPad5Pro() {
  ...
  const products: Product[] = [
    {
      ...
      badge: 'New',
      chip: 'Dimensity 9400',
      display: '13.0-inch 3.1K IPS LCD',
      memory: '12GB',
      storage: '256GB',
      details: [
        '2064 x 3096 resolution, 144Hz refresh rate',
        'Up to 1200 nits peak brightness, HDR10 support',
        '8-speaker Dolby Atmos audio system',
        'Slim 6.6mm aluminum body, lightweight design',
        'OriginOS 5 HD based on Android 15',
        '66W fast charging support',
        'Stylus support for notes and creativity'
      ],
      price: '$599.00',
      monthlyPrice: '$49.92',
    ...
    },
    {
      ...
      details: [
        ...
        'OriginOS 5 HD based on Android 15',
        '66W fast charging support',
        'Enhanced AI productivity features'
      ],
      price: '$649.00',
      monthlyPrice: '$54.08',
      finishes: ['Gray', 'Blue', 'White', 'Soft Pink'],
    ...
    },
    {
      ...
      details: [
        ...
        'Up to 1200 nits peak brightness, HDR10 support',
        '8-speaker Dolby Atmos audio system',
        'Flagship cooling with large VC system',
        'OriginOS 5 HD based on Android 15',
        '12050mAh battery for all-day use',
        'Pro multitasking and stylus precision'
      ],
      price: '$749.00',
      monthlyPrice: '$62.42',
      finishes: ['Gray', 'Blue', 'White', 'Soft Pink'],
  ...
  const considerations = [
    {
      ...
      description: 'Powerful 3nm flagship processor for smooth performance, gaming, and AI tasks.',
      features: [
        'Octa-core setup with high clock speeds',
        'Advanced GPU for graphics-intensive apps',
    ...
    },
    {
      ...
      description: 'Sharp, vibrant screen with high refresh rate for fluid scrolling and media.',
      features: [
        '2064 x 3096 resolution at 144Hz',
        '1200 nits peak brightness, HDR10',
    ...
    },
    {
      ...
      description: 'Precise input and multitasking features for notes, drawing, and work.',
      features: [
        'vivo Pencil support (low latency)',
    ...
    },
    {
      ...
      description: 'Exceptional endurance with quick top-ups for uninterrupted usage.',
      features: [
        '12050mAh capacity for extended sessions',
    ...
    return (
      <div style={{
        ...
        {product.image && (
          <img
            src={product.image}
            alt={`${product.chip} vivo Pad 5 Pro`}
            style={{
              width: '100%',
      ...
      <main style={{ paddingTop: '60px', flex: '1' }}>
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            vivo Pad 5 Pro with Dimensity 9400 and 12050mAh battery.
          </h1>
          <p style={{
            ...
            Have questions about buying a vivo tablet?
          </p>
          <button style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            What to consider when choosing your vivo Pad 5 Pro.
          </h2>
          <p style={{
            fontSize: '17px',
            color: '#6e6e73',
