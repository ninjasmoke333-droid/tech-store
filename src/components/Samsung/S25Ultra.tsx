...
export default function SamsungS25Ultra() {
  ...
  const products: Product[] = [
    {
      ...
      storage: '256GB',
      details: [
        'QHD+ resolution, 120Hz adaptive refresh rate',
        'Up to 2600 nits peak brightness',
        'Anti-reflective coating, Gorilla Armor 2',
        'Ultrasonic fingerprint sensor, IP68 water/dust resistance',
        '200MP main + 50MP 5x telephoto + 10MP 3x telephoto + 50MP ultra-wide',
    ...
    },
    {
      ...
      details: [
        ...
        'Ultrasonic fingerprint sensor, IP68 water/dust resistance',
        '200MP main + 50MP 5x telephoto + 10MP 3x telephoto + 50MP ultra-wide',
        'Advanced Galaxy AI features with on-device processing'
      ],
      price: '$1,659.99',
      monthlyPrice: '$138.33',
      finishes: ['Titanium Black', 'Titanium Gray', 'Titanium Silverblue', 'Titanium Whitesilver'],
  ...
  const considerations = [
    {
      ...
      description: 'The most powerful processor ever in a Galaxy phone, custom-tuned for exceptional performance and Galaxy AI.',
      features: [
        'Superior CPU and GPU for gaming and multitasking',
        'Advanced NPU for faster on-device AI processing',
    ...
    },
    {
      ...
      description: 'The brightest and most advanced display on a Galaxy phone, with incredible clarity and outdoor visibility.',
      features: [
        'QHD+ resolution with 120Hz adaptive refresh',
    ...
    },
    {
      ...
      description: 'Precision control for note-taking, drawing, and editing with the iconic S Pen — no charging required.',
      features: [
        'Air actions and gesture support',
        'Low-latency writing and sketching',
    ...
    },
    {
      ...
      description: '5000mAh battery with fast charging, plus the most advanced camera system for stunning photos and videos.',
      features: [
        'Up to 31 hours of video playback',
        '45W fast wired charging, wireless charging',
    ...
    return (
      <div style={{
        ...
        {product.image && (
          <img
            src={product.image}
            alt={`${product.chip} Galaxy S25 Ultra`}
            style={{
              width: '100%',
      ...
      <main style={{ paddingTop: '60px', flex: '1' }}>
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Galaxy S25 Ultra with Snapdragon 8 Elite for Galaxy.
          </h1>
          <p style={{
            ...
            Have questions about buying a Galaxy phone?
          </p>
          <button style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            What to consider when choosing your Galaxy S25 Ultra.
          </h2>
          <p style={{
            fontSize: '17px',
            color: '#6e6e73',
